...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/save-groupquerytoset
schema: 2.0.0
---

# Save-GroupQueryToSet
...
```
Save-GroupQueryToSet -Id <String> -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Save
```
Save-GroupQueryToSet -Id <String> -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SaveViaIdentity
```
Save-GroupQueryToSet -InputObject <IRunwayApiIdentity> -Query <IQuery> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SaveViaIdentityExpanded
```
Save-GroupQueryToSet -InputObject <IRunwayApiIdentity> -IncludeSubgroups -Skip <Int32> -SortDirection <String>
