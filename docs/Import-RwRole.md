...
online version: https://docs.microsoft.com/en-us/powershell/module/psrunway/import-rwrole
schema: 2.0.0
---
...
### Load (Default)
```
Import-RwRole -RoleId <String> [<CommonParameters>]
```

### LoadViaIdentity
```
Import-RwRole -InputObject <IPsRunwayIdentity> [<CommonParameters>]
```
