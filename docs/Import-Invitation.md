...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/import-invitation
schema: 2.0.0
---
...
### Load (Default)
```
Import-Invitation -Id <String> [<CommonParameters>]
```

### LoadViaIdentity
```
Import-Invitation -InputObject <IRunwayApiIdentity> [<CommonParameters>]
```
