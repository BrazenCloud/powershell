...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/invoke-queryrunner
schema: 2.0.0
---
...
### Query (Default)
```
Invoke-QueryRunner -GroupId <String> [<CommonParameters>]
```

### Query1
```
Invoke-QueryRunner -IPAddress <String> [<CommonParameters>]
```

### Query2
```
Invoke-QueryRunner -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### QueryExpanded
```
Invoke-QueryRunner -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### QueryViaIdentity
```
Invoke-QueryRunner -InputObject <IRunwayApiIdentity> [<CommonParameters>]
```
