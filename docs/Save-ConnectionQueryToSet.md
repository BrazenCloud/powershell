...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/save-connectionquerytoset
schema: 2.0.0
---

# Save-ConnectionQueryToSet
...
```
Save-ConnectionQueryToSet -Id <String> -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Save
```
Save-ConnectionQueryToSet -Id <String> -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SaveViaIdentity
```
Save-ConnectionQueryToSet -InputObject <IRunwayApiIdentity> -Query <IQuery> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SaveViaIdentityExpanded
```
Save-ConnectionQueryToSet -InputObject <IRunwayApiIdentity> -IncludeSubgroups -Skip <Int32>
