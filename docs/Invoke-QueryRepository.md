...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/invoke-queryrepository
schema: 2.0.0
---

# Invoke-QueryRepository
...
```
Invoke-QueryRepository -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Query
```
Invoke-QueryRepository -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
