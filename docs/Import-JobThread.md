...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/import-jobthread
schema: 2.0.0
---
...
### Load (Default)
```
Import-JobThread -Id <String> [<CommonParameters>]
```

### LoadViaIdentity
```
Import-JobThread -InputObject <IRunwayApiIdentity> [<CommonParameters>]
```
