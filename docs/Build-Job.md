...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/build-job
schema: 2.0.0
---
...
```
Build-Job [-ActionChainCommand <String>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Compile
```
Build-Job -Request <ICompileJobRequest> [-Confirm] [-WhatIf] [<CommonParameters>]
```
