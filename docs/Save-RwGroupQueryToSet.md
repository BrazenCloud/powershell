...
online version: https://docs.microsoft.com/en-us/powershell/module/psrunway/save-rwgroupquerytoset
schema: 2.0.0
---
...
### SaveViaIdentity
```
Save-RwGroupQueryToSet -InputObject <IPsRunwayIdentity> -Query <IQuery> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SaveViaIdentityExpanded
```
Save-RwGroupQueryToSet -InputObject <IPsRunwayIdentity> -IncludeSubgroups -Skip <Int32>
