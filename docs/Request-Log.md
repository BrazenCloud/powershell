...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/request-log
schema: 2.0.0
---
...
### Request (Default)
```
Request-Log -NodeId <String> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### RequestViaIdentity
```
Request-Log -InputObject <IRunwayApiIdentity> [-Confirm] [-WhatIf] [<CommonParameters>]
```
