...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/set-connection
schema: 2.0.0
---
...
```
Set-Connection -Id <String> -IsHidden -OutFile <String> [-ActionId <String>] [-AssignedEndpointId <String>]
...
### Update
```
Set-Connection -Id <String> -OutFile <String> -Request <IUpdateConnectionRequest> [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Set-Connection -InputObject <IRunwayApiIdentity> -OutFile <String> -Request <IUpdateConnectionRequest>
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Set-Connection -InputObject <IRunwayApiIdentity> -IsHidden -OutFile <String> [-Id <String>]
