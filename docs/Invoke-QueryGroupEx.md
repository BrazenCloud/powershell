...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/invoke-querygroupex
schema: 2.0.0
---
...
```
Invoke-QueryGroupEx -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Query
```
Invoke-QueryGroupEx -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### Runway.PowerShell.Models.IQueryResponseOfGroupQueryViewEx
