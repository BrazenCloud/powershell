...
online version: https://docs.microsoft.com/en-us/powershell/module/psrunway/invoke-rwqueryinvitation
schema: 2.0.0
---

# Invoke-RwQueryInvitation
...
```
Invoke-RwQueryInvitation -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Query
```
Invoke-RwQueryInvitation -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
