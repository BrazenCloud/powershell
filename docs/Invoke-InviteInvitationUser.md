...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/invoke-inviteinvitationuser
schema: 2.0.0
---

# Invoke-InviteInvitationUser
...
```
Invoke-InviteInvitationUser -OutFile <String> [-GroupId <String>] [-Invitations <IEmailInvitation[]>]
 [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Invite
```
Invoke-InviteInvitationUser -OutFile <String> -Request <IGroupInvitationRequest> [-PassThru] [-Confirm]
