...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/invoke-queryaccountasset
schema: 2.0.0
---

# Invoke-QueryAccountAsset
...
```
Invoke-QueryAccountAsset -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Query
```
Invoke-QueryAccountAsset -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
