...
online version: https://docs.microsoft.com/en-us/powershell/module/psrunway/invoke-rwcountinvitationquery
schema: 2.0.0
---

# Invoke-RwCountInvitationQuery
...
```
Invoke-RwCountInvitationQuery -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Invoke-RwCountInvitationQuery -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
