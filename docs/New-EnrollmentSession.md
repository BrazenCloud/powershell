...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/new-enrollmentsession
schema: 2.0.0
---
...
```
New-EnrollmentSession -Expiration <DateTime> -IsOneTime -Type <String> [-GroupId <String>]
 [-JobIds <String[]>] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-EnrollmentSession -Request <ICreateEnrollmentSessionRequest> [-Confirm] [-WhatIf] [<CommonParameters>]
```
