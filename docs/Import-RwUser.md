...
online version: https://docs.microsoft.com/en-us/powershell/module/psrunway/import-rwuser
schema: 2.0.0
---
...
### Load (Default)
```
Import-RwUser -UserId <String> [<CommonParameters>]
```

### LoadViaIdentity
```
Import-RwUser -InputObject <IPsRunwayIdentity> [<CommonParameters>]
```
