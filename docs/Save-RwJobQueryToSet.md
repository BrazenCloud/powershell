...
online version: https://docs.microsoft.com/en-us/powershell/module/psrunway/save-rwjobquerytoset
schema: 2.0.0
---
...
### SaveViaIdentity
```
Save-RwJobQueryToSet -InputObject <IPsRunwayIdentity> -Query <IQuery> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SaveViaIdentityExpanded
```
Save-RwJobQueryToSet -InputObject <IPsRunwayIdentity> -IncludeSubgroups -Skip <Int32> -SortDirection <String>
