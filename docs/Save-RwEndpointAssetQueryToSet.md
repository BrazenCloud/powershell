...
```
Save-RwEndpointAssetQueryToSet -Id <String> -IncludeSubgroups -Skip <Int32> -SortDirection <String>
...
### Save
```
Save-RwEndpointAssetQueryToSet -Id <String> -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
