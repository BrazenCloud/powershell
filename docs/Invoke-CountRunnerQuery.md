...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/invoke-countrunnerquery
schema: 2.0.0
---

# Invoke-CountRunnerQuery
...
```
Invoke-CountRunnerQuery -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Invoke-CountRunnerQuery -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
