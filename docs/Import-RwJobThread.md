...
online version: https://docs.microsoft.com/en-us/powershell/module/psrunway/import-rwjobthread
schema: 2.0.0
---
...
### Load (Default)
```
Import-RwJobThread -ThreadId <String> [<CommonParameters>]
```

### LoadViaIdentity
```
Import-RwJobThread -InputObject <IPsRunwayIdentity> [<CommonParameters>]
```
