...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/invoke-queryuser
schema: 2.0.0
---
...
```
Invoke-QueryUser -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32> [-FilterCaseSensitive]
...
### Query
```
Invoke-QueryUser -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
