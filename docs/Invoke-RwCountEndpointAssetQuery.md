...
online version: https://docs.microsoft.com/en-us/powershell/module/psrunway/invoke-rwcountendpointassetquery
schema: 2.0.0
---

# Invoke-RwCountEndpointAssetQuery
...
```
Invoke-RwCountEndpointAssetQuery -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Invoke-RwCountEndpointAssetQuery -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
