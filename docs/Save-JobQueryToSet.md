...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/save-jobquerytoset
schema: 2.0.0
---
...
```
Save-JobQueryToSet -Id <String> -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Save
```
Save-JobQueryToSet -Id <String> -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SaveViaIdentity
```
Save-JobQueryToSet -InputObject <IRunwayApiIdentity> -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SaveViaIdentityExpanded
```
Save-JobQueryToSet -InputObject <IRunwayApiIdentity> -IncludeSubgroups -Skip <Int32> -SortDirection <String>
