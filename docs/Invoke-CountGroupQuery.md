...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/invoke-countgroupquery
schema: 2.0.0
---

# Invoke-CountGroupQuery
...
```
Invoke-CountGroupQuery -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Invoke-CountGroupQuery -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
