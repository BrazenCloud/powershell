...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/invoke-queryendpointasset
schema: 2.0.0
---

# Invoke-QueryEndpointAsset
...
```
Invoke-QueryEndpointAsset -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Query
```
Invoke-QueryEndpointAsset -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
