...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/invoke-queryjob
schema: 2.0.0
---
...
```
Invoke-QueryJob -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32> [-FilterCaseSensitive]
...
### Query
```
Invoke-QueryJob -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
