...
online version: https://docs.microsoft.com/en-us/powershell/module/psrunway/invoke-rwcountrolequery
schema: 2.0.0
---

# Invoke-RwCountRoleQuery
...
```
Invoke-RwCountRoleQuery -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Invoke-RwCountRoleQuery -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
