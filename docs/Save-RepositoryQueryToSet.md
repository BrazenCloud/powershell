...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/save-repositoryquerytoset
schema: 2.0.0
---

# Save-RepositoryQueryToSet
...
```
Save-RepositoryQueryToSet -Id <String> -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Save
```
Save-RepositoryQueryToSet -Id <String> -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SaveViaIdentity
```
Save-RepositoryQueryToSet -InputObject <IRunwayApiIdentity> -Query <IQuery> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SaveViaIdentityExpanded
```
Save-RepositoryQueryToSet -InputObject <IRunwayApiIdentity> -IncludeSubgroups -Skip <Int32>
