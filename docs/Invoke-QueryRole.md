...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/invoke-queryrole
schema: 2.0.0
---
...
```
Invoke-QueryRole -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32> [-FilterCaseSensitive]
...
### Query
```
Invoke-QueryRole -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
