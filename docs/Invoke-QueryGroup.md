...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/invoke-querygroup
schema: 2.0.0
---
...
```
Invoke-QueryGroup -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32> [-FilterCaseSensitive]
...
### Query
```
Invoke-QueryGroup -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
