...
online version: https://docs.microsoft.com/en-us/powershell/module/psrunway/save-rwinvitationquerytoset
schema: 2.0.0
---

# Save-RwInvitationQueryToSet
...
```
Save-RwInvitationQueryToSet -Id <String> -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Save
```
Save-RwInvitationQueryToSet -Id <String> -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SaveViaIdentity
```
Save-RwInvitationQueryToSet -InputObject <IPsRunwayIdentity> -Query <IQuery> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SaveViaIdentityExpanded
```
Save-RwInvitationQueryToSet -InputObject <IPsRunwayIdentity> -IncludeSubgroups -Skip <Int32>
