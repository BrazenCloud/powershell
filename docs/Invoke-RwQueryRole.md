...
online version: https://docs.microsoft.com/en-us/powershell/module/psrunway/invoke-rwqueryrole
schema: 2.0.0
---
...
```
Invoke-RwQueryRole -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Query
```
Invoke-RwQueryRole -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
