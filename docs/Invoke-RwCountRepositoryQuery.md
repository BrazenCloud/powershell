...
online version: https://docs.microsoft.com/en-us/powershell/module/psrunway/invoke-rwcountrepositoryquery
schema: 2.0.0
---

# Invoke-RwCountRepositoryQuery
...
```
Invoke-RwCountRepositoryQuery -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Invoke-RwCountRepositoryQuery -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
