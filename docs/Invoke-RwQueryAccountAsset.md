...
online version: https://docs.microsoft.com/en-us/powershell/module/psrunway/invoke-rwqueryaccountasset
schema: 2.0.0
---

# Invoke-RwQueryAccountAsset
...
```
Invoke-RwQueryAccountAsset -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Query
```
Invoke-RwQueryAccountAsset -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
