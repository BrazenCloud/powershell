...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/new-role
schema: 2.0.0
---
...
```
New-Role [-Description <String>] [-GroupId <String>] [-Name <String>] [-Permissions <IRunwayRoleAccess[]>]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Create
```
New-Role -Request <ICreateRoleRequest> [-Confirm] [-WhatIf] [<CommonParameters>]
```
