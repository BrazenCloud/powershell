...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/invoke-countaccountassetquery
schema: 2.0.0
---

# Invoke-CountAccountAssetQuery
...
```
Invoke-CountAccountAssetQuery -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Invoke-CountAccountAssetQuery -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
