...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/get-jobthread
schema: 2.0.0
---
...
### Get1 (Default)
```
Get-JobThread [<CommonParameters>]
```

### Get
```
Get-JobThread -JobId <String> [<CommonParameters>]
```

### GetViaIdentity
```
Get-JobThread -InputObject <IRunwayApiIdentity> [<CommonParameters>]
```
