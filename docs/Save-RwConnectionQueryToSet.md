...
online version: https://docs.microsoft.com/en-us/powershell/module/psrunway/save-rwconnectionquerytoset
schema: 2.0.0
---

# Save-RwConnectionQueryToSet
...
```
Save-RwConnectionQueryToSet -Id <String> -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Save
```
Save-RwConnectionQueryToSet -Id <String> -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SaveViaIdentity
```
Save-RwConnectionQueryToSet -InputObject <IPsRunwayIdentity> -Query <IQuery> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SaveViaIdentityExpanded
```
Save-RwConnectionQueryToSet -InputObject <IPsRunwayIdentity> -IncludeSubgroups -Skip <Int32>
