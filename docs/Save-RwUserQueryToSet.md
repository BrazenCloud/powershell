...
online version: https://docs.microsoft.com/en-us/powershell/module/psrunway/save-rwuserquerytoset
schema: 2.0.0
---
...
```
Save-RwUserQueryToSet -Id <String> -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Save
```
Save-RwUserQueryToSet -Id <String> -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SaveViaIdentity
```
Save-RwUserQueryToSet -InputObject <IPsRunwayIdentity> -Query <IQuery> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SaveViaIdentityExpanded
```
Save-RwUserQueryToSet -InputObject <IPsRunwayIdentity> -IncludeSubgroups -Skip <Int32> -SortDirection <String>
