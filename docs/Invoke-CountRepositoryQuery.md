...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/invoke-countrepositoryquery
schema: 2.0.0
---

# Invoke-CountRepositoryQuery
...
```
Invoke-CountRepositoryQuery -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Invoke-CountRepositoryQuery -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
