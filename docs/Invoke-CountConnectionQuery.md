...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/invoke-countconnectionquery
schema: 2.0.0
---

# Invoke-CountConnectionQuery
...
```
Invoke-CountConnectionQuery -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Invoke-CountConnectionQuery -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
