...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/set-jobaction
schema: 2.0.0
---
...
### Update (Default)
```
Set-JobAction -JobId <String> -OutFile <String> -Request <IActionSettingRequest[]> [-PassThru] [-Confirm]
 [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentity
```
Set-JobAction -InputObject <IRunwayApiIdentity> -OutFile <String> -Request <IActionSettingRequest[]>
