...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/save-jobthreadquerytoset
schema: 2.0.0
---

# Save-JobThreadQueryToSet
...
```
Save-JobThreadQueryToSet -Id <String> -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Save
```
Save-JobThreadQueryToSet -Id <String> -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SaveViaIdentity
```
Save-JobThreadQueryToSet -InputObject <IRunwayApiIdentity> -Query <IQuery> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SaveViaIdentityExpanded
```
Save-JobThreadQueryToSet -InputObject <IRunwayApiIdentity> -IncludeSubgroups -Skip <Int32>
