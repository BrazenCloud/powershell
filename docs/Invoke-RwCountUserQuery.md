...
online version: https://docs.microsoft.com/en-us/powershell/module/psrunway/invoke-rwcountuserquery
schema: 2.0.0
---

# Invoke-RwCountUserQuery
...
```
Invoke-RwCountUserQuery -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Invoke-RwCountUserQuery -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
