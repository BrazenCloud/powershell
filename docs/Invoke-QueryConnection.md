...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/invoke-queryconnection
schema: 2.0.0
---

# Invoke-QueryConnection
...
```
Invoke-QueryConnection -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Query
```
Invoke-QueryConnection -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
