...
online version: https://docs.microsoft.com/en-us/powershell/module/psrunway/save-rwaccountassetquerytoset
schema: 2.0.0
---

# Save-RwAccountAssetQueryToSet
...
```
Save-RwAccountAssetQueryToSet -SetId <String> -IncludeSubgroups -Skip <Int32> -SortDirection <String>
...
### Save
```
Save-RwAccountAssetQueryToSet -SetId <String> -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SaveViaIdentity
```
Save-RwAccountAssetQueryToSet -InputObject <IPsRunwayIdentity> -Query <IQuery> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SaveViaIdentityExpanded
```
Save-RwAccountAssetQueryToSet -InputObject <IPsRunwayIdentity> -IncludeSubgroups -Skip <Int32>
