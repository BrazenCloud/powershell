...
```
Save-RwAccountAssetQueryToSet -Id <String> -IncludeSubgroups -Skip <Int32> -SortDirection <String>
...
### Save
```
Save-RwAccountAssetQueryToSet -Id <String> -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
