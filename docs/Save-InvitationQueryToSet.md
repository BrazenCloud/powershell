...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/save-invitationquerytoset
schema: 2.0.0
---

# Save-InvitationQueryToSet
...
```
Save-InvitationQueryToSet -Id <String> -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Save
```
Save-InvitationQueryToSet -Id <String> -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SaveViaIdentity
```
Save-InvitationQueryToSet -InputObject <IRunwayApiIdentity> -Query <IQuery> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SaveViaIdentityExpanded
```
Save-InvitationQueryToSet -InputObject <IRunwayApiIdentity> -IncludeSubgroups -Skip <Int32>
