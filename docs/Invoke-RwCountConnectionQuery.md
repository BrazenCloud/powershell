...
online version: https://docs.microsoft.com/en-us/powershell/module/psrunway/invoke-rwcountconnectionquery
schema: 2.0.0
---

# Invoke-RwCountConnectionQuery
...
```
Invoke-RwCountConnectionQuery -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Invoke-RwCountConnectionQuery -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
