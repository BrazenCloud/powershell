...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/invoke-countendpointassetquery
schema: 2.0.0
---

# Invoke-CountEndpointAssetQuery
...
```
Invoke-CountEndpointAssetQuery -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Invoke-CountEndpointAssetQuery -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
