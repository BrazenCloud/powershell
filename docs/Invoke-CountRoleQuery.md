...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/invoke-countrolequery
schema: 2.0.0
---

# Invoke-CountRoleQuery
...
```
Invoke-CountRoleQuery -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Invoke-CountRoleQuery -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
