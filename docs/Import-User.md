...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/import-user
schema: 2.0.0
---
...
### Load (Default)
```
Import-User -Id <String> [<CommonParameters>]
```

### LoadViaIdentity
```
Import-User -InputObject <IRunwayApiIdentity> [<CommonParameters>]
```
