...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/invoke-queryinvitation
schema: 2.0.0
---

# Invoke-QueryInvitation
...
```
Invoke-QueryInvitation -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Query
```
Invoke-QueryInvitation -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
