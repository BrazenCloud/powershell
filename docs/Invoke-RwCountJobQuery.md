...
online version: https://docs.microsoft.com/en-us/powershell/module/psrunway/invoke-rwcountjobquery
schema: 2.0.0
---

# Invoke-RwCountJobQuery
...
```
Invoke-RwCountJobQuery -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Invoke-RwCountJobQuery -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
