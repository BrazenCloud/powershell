...
online version: https://docs.microsoft.com/en-us/powershell/module/psrunway/invoke-rwqueryuser
schema: 2.0.0
---
...
```
Invoke-RwQueryUser -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Query
```
Invoke-RwQueryUser -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
