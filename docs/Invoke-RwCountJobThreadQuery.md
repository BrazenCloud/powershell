...
online version: https://docs.microsoft.com/en-us/powershell/module/psrunway/invoke-rwcountjobthreadquery
schema: 2.0.0
---

# Invoke-RwCountJobThreadQuery
...
```
Invoke-RwCountJobThreadQuery -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Invoke-RwCountJobThreadQuery -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
