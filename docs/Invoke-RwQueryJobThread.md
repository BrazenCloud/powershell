...
online version: https://docs.microsoft.com/en-us/powershell/module/psrunway/invoke-rwqueryjobthread
schema: 2.0.0
---

# Invoke-RwQueryJobThread
...
```
Invoke-RwQueryJobThread -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Query
```
Invoke-RwQueryJobThread -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
