...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/invoke-queryjobthread
schema: 2.0.0
---

# Invoke-QueryJobThread
...
```
Invoke-QueryJobThread -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Query
```
Invoke-QueryJobThread -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
