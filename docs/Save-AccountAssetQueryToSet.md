...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/save-accountassetquerytoset
schema: 2.0.0
---

# Save-AccountAssetQueryToSet
...
```
Save-AccountAssetQueryToSet -Id <String> -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Save
```
Save-AccountAssetQueryToSet -Id <String> -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SaveViaIdentity
```
Save-AccountAssetQueryToSet -InputObject <IRunwayApiIdentity> -Query <IQuery> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SaveViaIdentityExpanded
```
Save-AccountAssetQueryToSet -InputObject <IRunwayApiIdentity> -IncludeSubgroups -Skip <Int32>
