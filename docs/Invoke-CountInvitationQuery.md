...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/invoke-countinvitationquery
schema: 2.0.0
---

# Invoke-CountInvitationQuery
...
```
Invoke-CountInvitationQuery -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Invoke-CountInvitationQuery -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
