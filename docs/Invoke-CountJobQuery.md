...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/invoke-countjobquery
schema: 2.0.0
---

# Invoke-CountJobQuery
...
```
Invoke-CountJobQuery -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Invoke-CountJobQuery -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
