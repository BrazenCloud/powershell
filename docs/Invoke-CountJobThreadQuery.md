...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/invoke-countjobthreadquery
schema: 2.0.0
---

# Invoke-CountJobThreadQuery
...
```
Invoke-CountJobThreadQuery -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Invoke-CountJobThreadQuery -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
