...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/import-repository
schema: 2.0.0
---
...
### Load (Default)
```
Import-Repository -Name <String> [<CommonParameters>]
```

### Load1
```
Import-Repository -Id <String> [<CommonParameters>]
```

### LoadViaIdentity
```
Import-Repository -InputObject <IRunwayApiIdentity> [<CommonParameters>]
```
