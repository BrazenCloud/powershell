...
online version: https://docs.microsoft.com/en-us/powershell/module/psrunway/invoke-rwqueryrepository
schema: 2.0.0
---

# Invoke-RwQueryRepository
...
```
Invoke-RwQueryRepository -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Query
```
Invoke-RwQueryRepository -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
