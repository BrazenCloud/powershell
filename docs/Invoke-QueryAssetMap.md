...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/invoke-queryassetmap
schema: 2.0.0
---

# Invoke-QueryAssetMap
...
```
Invoke-QueryAssetMap -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Query
```
Invoke-QueryAssetMap -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
