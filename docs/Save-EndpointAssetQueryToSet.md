...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/save-endpointassetquerytoset
schema: 2.0.0
---

# Save-EndpointAssetQueryToSet
...
```
Save-EndpointAssetQueryToSet -Id <String> -IncludeSubgroups -Skip <Int32> -SortDirection <String>
...
### Save
```
Save-EndpointAssetQueryToSet -Id <String> -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SaveViaIdentity
```
Save-EndpointAssetQueryToSet -InputObject <IRunwayApiIdentity> -Query <IQuery> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SaveViaIdentityExpanded
```
Save-EndpointAssetQueryToSet -InputObject <IRunwayApiIdentity> -IncludeSubgroups -Skip <Int32>
