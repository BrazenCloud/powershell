...
online version: https://docs.microsoft.com/en-us/powershell/module/psrunway/save-rwjobthreadquerytoset
schema: 2.0.0
---

# Save-RwJobThreadQueryToSet
...
```
Save-RwJobThreadQueryToSet -Id <String> -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Save
```
Save-RwJobThreadQueryToSet -Id <String> -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SaveViaIdentity
```
Save-RwJobThreadQueryToSet -InputObject <IPsRunwayIdentity> -Query <IQuery> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SaveViaIdentityExpanded
```
Save-RwJobThreadQueryToSet -InputObject <IPsRunwayIdentity> -IncludeSubgroups -Skip <Int32>
