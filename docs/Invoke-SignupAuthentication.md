...
online version: https://docs.microsoft.com/en-us/powershell/module/runwayapi/invoke-signupauthentication
schema: 2.0.0
---

# Invoke-SignupAuthentication
...
```
Invoke-SignupAuthentication -OutFile <String> [-Captcha <String>] [-Company <String>] [-EmailAddress <String>]
 [-Name <String>] [-Password <String>] [-Phone <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Signup
```
Invoke-SignupAuthentication -OutFile <String> -Request <ISignupRequest> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
