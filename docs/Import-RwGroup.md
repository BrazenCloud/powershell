...
online version: https://docs.microsoft.com/en-us/powershell/module/psrunway/import-rwgroup
schema: 2.0.0
---
...
### Load (Default)
```
Import-RwGroup -GroupId <String> [<CommonParameters>]
```

### LoadViaIdentity
```
Import-RwGroup -InputObject <IPsRunwayIdentity> [<CommonParameters>]
```
