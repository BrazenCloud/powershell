...
$paths = @{
    '/api/v2/users/{userId}'                        = @( 'delete', 'put' ) # User_DeleteById,User_Update
    '/api/v2/groups'                                = @( 'delete' ) # Group_DeleteBySet
    '/api/v2/shell/ping'                            = @( 'post' ) # RemoteShell_ShellPing
    '/api/v2/charts/{groupId}'                      = @( 'post', 'get' ) # Chart_SaveCharts,Chart_GetCharts
    '/api/v2/charts/{indexName}/chart-data'         = @( 'post' ) # Chart_PlotChart
    ...
    '/api/v2/connections/{connectionId}'            = @( 'delete', 'put' ) # Connection_DeleteById,Connection_Update
    '/api/v2/users'                                 = @( 'delete' ) # User_DeleteBySet
    '/api/v2/datastore/{indexName}/{groupId}/query' = @( 'post' ) # DataStore_Query
    ...
    '/api/v2/invitations'                           = @( 'delete', 'put', 'post' ) # Invitation_DeleteBySet,Invitation_AnswerInvitation,Invitation_InviteUsers
    '/api/v2/accounts'                              = @( 'delete' ) # AccountAsset_DeleteBySet
    '/api/v2/groups/{groupId}'                      = @( 'delete', 'put' ) # Group_DeleteById,Group_Update
    ...
    '/api/v2/roles/{roleId}'                        = @( 'delete', 'put' ) # Role_DeleteById,Role_Update
