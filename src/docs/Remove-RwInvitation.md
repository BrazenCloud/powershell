...
```
Remove-RwInvitation -OutFile <String> [-Id <String>] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```

### Delete
```
Remove-RwInvitation -OutFile <String> -SetRequest <IIdRequest> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```
