...
external help file:
Module Name: Runway
online version: https://docs.microsoft.com/en-us/powershell/module/runway/get-rwuserquerycount
schema: 2.0.0
---

# Get-RwUserQueryCount
...
```
Get-RwUserQueryCount -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Get-RwUserQueryCount -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
