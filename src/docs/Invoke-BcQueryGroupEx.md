...
online version: https://docs.microsoft.com/en-us/powershell/module/brazencloud/invoke-bcquerygroupex
schema: 2.0.0
---

# Invoke-BcQueryGroupEx
...
```
Invoke-BcQueryGroupEx -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Query
```
Invoke-BcQueryGroupEx -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### BrazenCloudSdk.PowerShell.Models.IQueryResponseOfGroupQueryViewEx
