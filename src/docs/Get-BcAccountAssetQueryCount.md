...
online version: https://docs.microsoft.com/en-us/powershell/module/brazencloud/get-bcaccountassetquerycount
schema: 2.0.0
---

# Get-BcAccountAssetQueryCount
...
```
Get-BcAccountAssetQueryCount -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Get-BcAccountAssetQueryCount -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
