...
online version: https://docs.microsoft.com/en-us/powershell/module/brazencloud/get-bcgroupquerycount
schema: 2.0.0
---

# Get-BcGroupQueryCount
...
```
Get-BcGroupQueryCount -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Get-BcGroupQueryCount -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
