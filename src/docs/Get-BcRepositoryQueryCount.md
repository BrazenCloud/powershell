...
online version: https://docs.microsoft.com/en-us/powershell/module/brazencloud/get-bcrepositoryquerycount
schema: 2.0.0
---

# Get-BcRepositoryQueryCount
...
```
Get-BcRepositoryQueryCount -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Get-BcRepositoryQueryCount -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
