...
online version: https://docs.microsoft.com/en-us/powershell/module/brazencloud/get-bcuserquerycount
schema: 2.0.0
---

# Get-BcUserQueryCount
...
```
Get-BcUserQueryCount -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Get-BcUserQueryCount -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
