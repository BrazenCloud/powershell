...
online version: https://docs.microsoft.com/en-us/powershell/module/brazencloud/save-bcrepositoryquerytoset
schema: 2.0.0
---

# Save-BcRepositoryQueryToSet
...
```
Save-BcRepositoryQueryToSet -SetId <String> -IncludeSubgroups -Skip <Int32> -SortDirection <String>
...
### Save
```
Save-BcRepositoryQueryToSet -SetId <String> -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SaveViaIdentity
```
Save-BcRepositoryQueryToSet -InputObject <IBrazenCloudIdentity> -Query <IQuery> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SaveViaIdentityExpanded
```
Save-BcRepositoryQueryToSet -InputObject <IBrazenCloudIdentity> -IncludeSubgroups -Skip <Int32>
