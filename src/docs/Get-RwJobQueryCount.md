...
external help file:
Module Name: Runway
online version: https://docs.microsoft.com/en-us/powershell/module/runway/get-rwjobquerycount
schema: 2.0.0
---
...
```
Get-RwJobQueryCount -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Get-RwJobQueryCount -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
