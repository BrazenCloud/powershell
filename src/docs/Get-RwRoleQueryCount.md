...
```
Get-RwRoleQueryCount -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Get-RwRoleQueryCount -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
