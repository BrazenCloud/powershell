...
external help file:
Module Name: Runway
online version: https://docs.microsoft.com/en-us/powershell/module/runway/enable-rwjob
schema: 2.0.0
---
...
### EnableViaIdentity
```
Enable-RwJob -InputObject <IRunwayIdentity> [-Value] [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
