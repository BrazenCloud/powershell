...
external help file:
Module Name: Runway
online version: https://docs.microsoft.com/en-us/powershell/module/runway/get-rwrunnerquerycount
schema: 2.0.0
---

# Get-RwRunnerQueryCount
...
```
Get-RwRunnerQueryCount -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Get-RwRunnerQueryCount -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
