...
online version: https://docs.microsoft.com/en-us/powershell/module/brazencloud/invoke-bcqueryuser
schema: 2.0.0
---
...
```
Invoke-BcQueryUser -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Query
```
Invoke-BcQueryUser -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### BrazenCloudSdk.PowerShell.Models.IQueryResponseOfIUserQueryView
