...
```
Save-RwConnectionQueryToSet -SetId <String> -IncludeSubgroups -Skip <Int32> -SortDirection <String>
...
### Save
```
Save-RwConnectionQueryToSet -SetId <String> -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
