...
external help file:
Module Name: Runway
online version: https://docs.microsoft.com/en-us/powershell/module/runway/save-rwconnectionquerytoset
schema: 2.0.0
---
...
### SaveViaIdentity
```
Save-RwConnectionQueryToSet -InputObject <IRunwayIdentity> -Query <IQuery> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SaveViaIdentityExpanded
```
Save-RwConnectionQueryToSet -InputObject <IRunwayIdentity> -IncludeSubgroups -Skip <Int32>
