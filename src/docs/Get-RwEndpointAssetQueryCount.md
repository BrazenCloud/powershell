...
external help file:
Module Name: Runway
online version: https://docs.microsoft.com/en-us/powershell/module/runway/get-rwendpointassetquerycount
schema: 2.0.0
---

# Get-RwEndpointAssetQueryCount
...
```
Get-RwEndpointAssetQueryCount -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Get-RwEndpointAssetQueryCount -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Invoke-RwEndpointAssetQueryCount
