...
online version: https://docs.microsoft.com/en-us/powershell/module/brazencloud/invoke-bcqueryinvitation
schema: 2.0.0
---

# Invoke-BcQueryInvitation
...
```
Invoke-BcQueryInvitation -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Query
```
Invoke-BcQueryInvitation -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
