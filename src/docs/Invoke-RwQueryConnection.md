...
online version: https://docs.microsoft.com/en-us/powershell/module/psrunway/invoke-rwqueryconnection
schema: 2.0.0
---

# Invoke-RwQueryConnection
...
```
Invoke-RwQueryConnection -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Query
```
Invoke-RwQueryConnection -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
