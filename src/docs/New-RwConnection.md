...
```
New-RwConnection -IsHidden [-ActionId <String>] [-AssignedEndpointId <String>] [-Description <String>]
...
### Create
```
New-RwConnection -Request <ICreateConnectionRequest> [-Confirm] [-WhatIf] [<CommonParameters>]
```
