...
online version: https://docs.microsoft.com/en-us/powershell/module/brazencloud/get-bcconnectionquerycount
schema: 2.0.0
---

# Get-BcConnectionQueryCount
...
```
Get-BcConnectionQueryCount -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Get-BcConnectionQueryCount -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
