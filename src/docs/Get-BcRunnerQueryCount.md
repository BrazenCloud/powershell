...
online version: https://docs.microsoft.com/en-us/powershell/module/brazencloud/get-bcrunnerquerycount
schema: 2.0.0
---

# Get-BcRunnerQueryCount
...
```
Get-BcRunnerQueryCount -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Get-BcRunnerQueryCount -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
