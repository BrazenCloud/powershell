...
online version: https://docs.microsoft.com/en-us/powershell/module/brazencloud/invoke-bcqueryconnection
schema: 2.0.0
---

# Invoke-BcQueryConnection
...
```
Invoke-BcQueryConnection -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Query
```
Invoke-BcQueryConnection -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
