...
online version: https://docs.microsoft.com/en-us/powershell/module/brazencloud/invoke-bcquerygroup
schema: 2.0.0
---
...
```
Invoke-BcQueryGroup -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Query
```
Invoke-BcQueryGroup -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### BrazenCloudSdk.PowerShell.Models.IQueryResponseOfIGroupQueryView
