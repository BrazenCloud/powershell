...
online version: https://docs.microsoft.com/en-us/powershell/module/brazencloud/get-bcrolequerycount
schema: 2.0.0
---

# Get-BcRoleQueryCount
...
```
Get-BcRoleQueryCount -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Get-BcRoleQueryCount -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
