...
online version: https://docs.microsoft.com/en-us/powershell/module/brazencloud/save-bcjobthreadquerytoset
schema: 2.0.0
---

# Save-BcJobThreadQueryToSet
...
```
Save-BcJobThreadQueryToSet -SetId <String> -IncludeSubgroups -Skip <Int32> -SortDirection <String>
...
### Save
```
Save-BcJobThreadQueryToSet -SetId <String> -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SaveViaIdentity
```
Save-BcJobThreadQueryToSet -InputObject <IBrazenCloudIdentity> -Query <IQuery> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SaveViaIdentityExpanded
```
Save-BcJobThreadQueryToSet -InputObject <IBrazenCloudIdentity> -IncludeSubgroups -Skip <Int32>
