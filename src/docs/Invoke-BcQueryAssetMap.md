...
online version: https://docs.microsoft.com/en-us/powershell/module/brazencloud/invoke-bcqueryassetmap
schema: 2.0.0
---

# Invoke-BcQueryAssetMap
...
```
Invoke-BcQueryAssetMap -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Query
```
Invoke-BcQueryAssetMap -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### BrazenCloudSdk.PowerShell.Models.IQueryResponseOfAssetMapEndpointView
