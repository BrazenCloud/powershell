...
online version: https://docs.microsoft.com/en-us/powershell/module/brazencloud/save-bcendpointassetquerytoset
schema: 2.0.0
---

# Save-BcEndpointAssetQueryToSet
...
```
Save-BcEndpointAssetQueryToSet -SetId <String> -IncludeSubgroups -Skip <Int32> -SortDirection <String>
...
### Save
```
Save-BcEndpointAssetQueryToSet -SetId <String> -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SaveViaIdentity
```
Save-BcEndpointAssetQueryToSet -InputObject <IBrazenCloudIdentity> -Query <IQuery> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SaveViaIdentityExpanded
```
Save-BcEndpointAssetQueryToSet -InputObject <IBrazenCloudIdentity> -IncludeSubgroups -Skip <Int32>
