...
online version: https://docs.microsoft.com/en-us/powershell/module/brazencloud/get-bcqueryacassetcount
schema: 2.0.0
---

# Get-BcQueryAcAssetCount
...
```
Get-BcQueryAcAssetCount -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Query
```
Get-BcQueryAcAssetCount -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
