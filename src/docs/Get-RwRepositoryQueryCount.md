...
external help file:
Module Name: Runway
online version: https://docs.microsoft.com/en-us/powershell/module/runway/get-rwrepositoryquerycount
schema: 2.0.0
---

# Get-RwRepositoryQueryCount
...
```
Get-RwRepositoryQueryCount -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Get-RwRepositoryQueryCount -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
