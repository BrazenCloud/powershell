...
external help file:
Module Name: Runway
online version: https://docs.microsoft.com/en-us/powershell/module/runway/save-rwinvitationquerytoset
schema: 2.0.0
---
...
### SaveViaIdentity
```
Save-RwInvitationQueryToSet -InputObject <IRunwayIdentity> -Query <IQuery> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SaveViaIdentityExpanded
```
Save-RwInvitationQueryToSet -InputObject <IRunwayIdentity> -IncludeSubgroups -Skip <Int32>
