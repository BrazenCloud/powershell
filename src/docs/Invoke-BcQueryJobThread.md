...
online version: https://docs.microsoft.com/en-us/powershell/module/brazencloud/invoke-bcqueryjobthread
schema: 2.0.0
---

# Invoke-BcQueryJobThread
...
```
Invoke-BcQueryJobThread -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Query
```
Invoke-BcQueryJobThread -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
