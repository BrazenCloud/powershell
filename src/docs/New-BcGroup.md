...
online version: https://docs.microsoft.com/en-us/powershell/module/brazencloud/new-bcgroup
schema: 2.0.0
---
...
```
New-BcGroup -LicenseAllocatedRunners <Int32> -LicenseCanAssignSubLicenses [-Description <String>]
...
### Create
```
New-BcGroup -Request <ICreateGroupRequest> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
```yaml
Type: BrazenCloudSdk.PowerShell.Models.ICreateGroupRequest
...
### BrazenCloudSdk.PowerShell.Models.ICreateGroupRequest
