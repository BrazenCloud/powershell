...
external help file:
Module Name: Runway
online version: https://docs.microsoft.com/en-us/powershell/module/runway/test-rwauthenticationemailunique
schema: 2.0.0
---
...
### IsViaIdentity
```
Test-RwAuthenticationEmailUnique -InputObject <IRunwayIdentity> [<CommonParameters>]
```
