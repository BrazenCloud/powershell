...
external help file:
Module Name: Runway
online version: https://docs.microsoft.com/en-us/powershell/module/runway/get-rwjobthreadquerycount
schema: 2.0.0
---

# Get-RwJobThreadQueryCount
...
```
Get-RwJobThreadQueryCount -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Get-RwJobThreadQueryCount -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
