...
external help file:
Module Name: Runway
online version: https://docs.microsoft.com/en-us/powershell/module/runway/get-rwconnection
schema: 2.0.0
---
...
Returns Connections from the Runway API.
...
### Load
```
Get-RwConnection -ConnectionId <String> [<CommonParameters>]
```

### LoadViaIdentity
```
Get-RwConnection -InputObject <IRunwayIdentity> [<CommonParameters>]
```
