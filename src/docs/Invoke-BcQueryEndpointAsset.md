...
online version: https://docs.microsoft.com/en-us/powershell/module/brazencloud/invoke-bcqueryendpointasset
schema: 2.0.0
---

# Invoke-BcQueryEndpointAsset
...
```
Invoke-BcQueryEndpointAsset -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Query
```
Invoke-BcQueryEndpointAsset -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
