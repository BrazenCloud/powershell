...
external help file:
Module Name: Runway
online version: https://docs.microsoft.com/en-us/powershell/module/runway/get-rwgroup
schema: 2.0.0
---
...
Returns Groups from the Runway API.
...
### Load
```
Get-RwGroup -GroupId <String> [<CommonParameters>]
```

### LoadViaIdentity
```
Get-RwGroup -InputObject <IRunwayIdentity> [<CommonParameters>]
```
