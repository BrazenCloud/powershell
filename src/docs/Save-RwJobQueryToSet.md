...
external help file:
Module Name: Runway
online version: https://docs.microsoft.com/en-us/powershell/module/runway/save-rwjobquerytoset
schema: 2.0.0
---

# Save-RwJobQueryToSet
...
### SaveViaIdentity
```
Save-RwJobQueryToSet -InputObject <IRunwayIdentity> -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SaveViaIdentityExpanded
```
Save-RwJobQueryToSet -InputObject <IRunwayIdentity> -IncludeSubgroups -Skip <Int32> -SortDirection <String>
