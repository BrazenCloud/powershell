...
online version: https://docs.microsoft.com/en-us/powershell/module/psrunway/invoke-rwquerygroup
schema: 2.0.0
---
...
```
Invoke-RwQueryGroup -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Query
```
Invoke-RwQueryGroup -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
