...
external help file:
Module Name: Runway
online version: https://docs.microsoft.com/en-us/powershell/module/runway/get-rwgroupquerycount
schema: 2.0.0
---

# Get-RwGroupQueryCount
...
```
Get-RwGroupQueryCount -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Get-RwGroupQueryCount -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
