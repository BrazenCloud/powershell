...
```
Invoke-RwQueryJob -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32> [-FilterCaseSensitive]
...
### Query
```
Invoke-RwQueryJob -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
