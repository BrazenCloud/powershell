...
online version: https://docs.microsoft.com/en-us/powershell/module/brazencloud/get-bcjobquerycount
schema: 2.0.0
---
...
```
Get-BcJobQueryCount -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Get-BcJobQueryCount -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
