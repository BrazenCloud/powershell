...
external help file:
Module Name: Runway
online version: https://docs.microsoft.com/en-us/powershell/module/runway/get-rwconnectionquerycount
schema: 2.0.0
---

# Get-RwConnectionQueryCount
...
```
Get-RwConnectionQueryCount -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Get-RwConnectionQueryCount -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
