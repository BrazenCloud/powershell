...
external help file:
Module Name: Runway
online version: https://docs.microsoft.com/en-us/powershell/module/runway/send-rwresultdownload
schema: 2.0.0
---

# Send-RwResultDownload
...
### NotifyViaIdentity
```
Send-RwResultDownload -InputObject <IRunwayIdentity> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
