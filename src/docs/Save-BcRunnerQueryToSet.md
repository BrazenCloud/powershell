...
online version: https://docs.microsoft.com/en-us/powershell/module/brazencloud/save-bcrunnerquerytoset
schema: 2.0.0
---

# Save-BcRunnerQueryToSet
...
```
Save-BcRunnerQueryToSet -SetId <String> -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Save
```
Save-BcRunnerQueryToSet -SetId <String> -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SaveViaIdentity
```
Save-BcRunnerQueryToSet -InputObject <IBrazenCloudIdentity> -Query <IQuery> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SaveViaIdentityExpanded
```
Save-BcRunnerQueryToSet -InputObject <IBrazenCloudIdentity> -IncludeSubgroups -Skip <Int32>
