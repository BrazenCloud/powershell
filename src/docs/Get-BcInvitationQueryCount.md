...
online version: https://docs.microsoft.com/en-us/powershell/module/brazencloud/get-bcinvitationquerycount
schema: 2.0.0
---

# Get-BcInvitationQueryCount
...
```
Get-BcInvitationQueryCount -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Get-BcInvitationQueryCount -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
