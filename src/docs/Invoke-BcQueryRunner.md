...
online version: https://docs.microsoft.com/en-us/powershell/module/brazencloud/invoke-bcqueryrunner
schema: 2.0.0
---

# Invoke-BcQueryRunner
...
### Query (Default)
```
Invoke-BcQueryRunner -GroupId <String> [<CommonParameters>]
```

### Query1
```
Invoke-BcQueryRunner -IPAddress <String> [<CommonParameters>]
```

### Query2
```
Invoke-BcQueryRunner -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### QueryExpanded
```
Invoke-BcQueryRunner -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### QueryViaIdentity
```
Invoke-BcQueryRunner -InputObject <IBrazenCloudIdentity> [<CommonParameters>]
```
...
### BrazenCloudSdk.PowerShell.Models.IQueryResponseOfIRunnerQueryView
