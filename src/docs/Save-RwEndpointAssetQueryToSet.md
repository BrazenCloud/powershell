...
online version: https://docs.microsoft.com/en-us/powershell/module/psrunway/save-rwendpointassetquerytoset
schema: 2.0.0
---

# Save-RwEndpointAssetQueryToSet
...
```
Save-RwEndpointAssetQueryToSet -SetId <String> -IncludeSubgroups -Skip <Int32> -SortDirection <String>
...
### Save
```
Save-RwEndpointAssetQueryToSet -SetId <String> -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SaveViaIdentity
```
Save-RwEndpointAssetQueryToSet -InputObject <IPsRunwayIdentity> -Query <IQuery> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SaveViaIdentityExpanded
```
Save-RwEndpointAssetQueryToSet -InputObject <IPsRunwayIdentity> -IncludeSubgroups -Skip <Int32>
