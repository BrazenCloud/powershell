...
external help file:
Module Name: Runway
online version: https://docs.microsoft.com/en-us/powershell/module/runway/save-rwendpointassetquerytoset
schema: 2.0.0
---
...
### SaveViaIdentity
```
Save-RwEndpointAssetQueryToSet -InputObject <IRunwayIdentity> -Query <IQuery> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SaveViaIdentityExpanded
```
Save-RwEndpointAssetQueryToSet -InputObject <IRunwayIdentity> -IncludeSubgroups -Skip <Int32>
