...
online version: https://docs.microsoft.com/en-us/powershell/module/brazencloud/save-bcconnectionquerytoset
schema: 2.0.0
---

# Save-BcConnectionQueryToSet
...
```
Save-BcConnectionQueryToSet -SetId <String> -IncludeSubgroups -Skip <Int32> -SortDirection <String>
...
### Save
```
Save-BcConnectionQueryToSet -SetId <String> -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```

### SaveViaIdentity
```
Save-BcConnectionQueryToSet -InputObject <IBrazenCloudIdentity> -Query <IQuery> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SaveViaIdentityExpanded
```
Save-BcConnectionQueryToSet -InputObject <IBrazenCloudIdentity> -IncludeSubgroups -Skip <Int32>
