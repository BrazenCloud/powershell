...
```
Request-RwResultActionResult [-ActionId <String>] [-ThreadId <String>] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### Request
```
Request-RwResultActionResult -Request <IActionResultRequest> [-Confirm] [-WhatIf] [<CommonParameters>]
```
