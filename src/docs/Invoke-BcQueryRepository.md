...
online version: https://docs.microsoft.com/en-us/powershell/module/brazencloud/invoke-bcqueryrepository
schema: 2.0.0
---

# Invoke-BcQueryRepository
...
```
Invoke-BcQueryRepository -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Query
```
Invoke-BcQueryRepository -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
