...
online version: https://docs.microsoft.com/en-us/powershell/module/brazencloud/invoke-bcqueryrole
schema: 2.0.0
---
...
```
Invoke-BcQueryRole -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Query
```
Invoke-BcQueryRole -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
