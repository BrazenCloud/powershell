...
online version: https://docs.microsoft.com/en-us/powershell/module/brazencloud/get-bcjobthreadquerycount
schema: 2.0.0
---

# Get-BcJobThreadQueryCount
...
```
Get-BcJobThreadQueryCount -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Get-BcJobThreadQueryCount -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
