...
online version: https://docs.microsoft.com/en-us/powershell/module/psrunway/invoke-rwqueryassetmap
schema: 2.0.0
---

# Invoke-RwQueryAssetMap
...
```
Invoke-RwQueryAssetMap -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Query
```
Invoke-RwQueryAssetMap -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
### Runway.PowerShell.Models.IQueryResponseOfAssetMapEndpointView
