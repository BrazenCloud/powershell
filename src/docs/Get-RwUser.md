...
external help file:
Module Name: Runway
online version: https://docs.microsoft.com/en-us/powershell/module/runway/get-rwuser
schema: 2.0.0
---
...
Returns Users from the Runway API.

## SYNTAX

### List (Default)
```
Get-RwUser [<CommonParameters>]
```

### Load
```
Get-RwUser -UserId <String> [<CommonParameters>]
```

### LoadViaIdentity
```
Get-RwUser -InputObject <IRunwayIdentity> [<CommonParameters>]
```
