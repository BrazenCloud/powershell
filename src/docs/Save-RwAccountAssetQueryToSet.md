...
external help file:
Module Name: Runway
online version: https://docs.microsoft.com/en-us/powershell/module/runway/save-rwaccountassetquerytoset
schema: 2.0.0
---
...
### SaveViaIdentity
```
Save-RwAccountAssetQueryToSet -InputObject <IRunwayIdentity> -Query <IQuery> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SaveViaIdentityExpanded
```
Save-RwAccountAssetQueryToSet -InputObject <IRunwayIdentity> -IncludeSubgroups -Skip <Int32>
