...
external help file:
Module Name: Runway
online version: https://docs.microsoft.com/en-us/powershell/module/runway/get-rwqueryacassetcount
schema: 2.0.0
---

# Get-RwQueryAcAssetCount
...
```
Get-RwQueryAcAssetCount -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Query
```
Get-RwQueryAcAssetCount -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
