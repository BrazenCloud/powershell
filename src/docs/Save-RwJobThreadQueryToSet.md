...
external help file:
Module Name: Runway
online version: https://docs.microsoft.com/en-us/powershell/module/runway/save-rwjobthreadquerytoset
schema: 2.0.0
---
...
### SaveViaIdentity
```
Save-RwJobThreadQueryToSet -InputObject <IRunwayIdentity> -Query <IQuery> [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### SaveViaIdentityExpanded
```
Save-RwJobThreadQueryToSet -InputObject <IRunwayIdentity> -IncludeSubgroups -Skip <Int32>
