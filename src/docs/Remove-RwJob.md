...
external help file:
Module Name: Runway
online version: https://docs.microsoft.com/en-us/powershell/module/runway/remove-rwjob
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-RwJob -InputObject <IRunwayIdentity> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
