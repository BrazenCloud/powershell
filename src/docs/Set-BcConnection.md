...
online version: https://docs.microsoft.com/en-us/powershell/module/brazencloud/set-bcconnection
schema: 2.0.0
---
...
```
Set-BcConnection -ConnectionId <String> -IsHidden [-ActionId <String>] [-AssignedEndpointId <String>]
...
### Update
```
Set-BcConnection -ConnectionId <String> -Request <IUpdateConnectionRequest> [-PassThru] [-Confirm] [-WhatIf]
 [<CommonParameters>]
```

### UpdateViaIdentity
```
Set-BcConnection -InputObject <IBrazenCloudIdentity> -Request <IUpdateConnectionRequest> [-PassThru]
 [-Confirm] [-WhatIf] [<CommonParameters>]
```

### UpdateViaIdentityExpanded
```
Set-BcConnection -InputObject <IBrazenCloudIdentity> -IsHidden [-ActionId <String>]
...
```yaml
Type: BrazenCloudSdk.PowerShell.Models.IUpdateConnectionRequest
...
### BrazenCloudSdk.PowerShell.Models.IUpdateConnectionRequest
