...
external help file:
Module Name: Runway
online version: https://docs.microsoft.com/en-us/powershell/module/runway/get-rwaccountassetquerycount
schema: 2.0.0
---

# Get-RwAccountAssetQueryCount
...
```
Get-RwAccountAssetQueryCount -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Get-RwAccountAssetQueryCount -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
...
Invoke-RwAccountAssetQueryCount
