...
external help file:
Module Name: Runway
online version: https://docs.microsoft.com/en-us/powershell/module/runway/remove-rwjobthread
schema: 2.0.0
---
...
### DeleteViaIdentity
```
Remove-RwJobThread -InputObject <IRunwayIdentity> [-PassThru] [-Confirm] [-WhatIf] [<CommonParameters>]
```
