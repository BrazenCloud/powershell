...
online version: https://docs.microsoft.com/en-us/powershell/module/brazencloud/get-bcendpointassetquerycount
schema: 2.0.0
---

# Get-BcEndpointAssetQueryCount
...
```
Get-BcEndpointAssetQueryCount -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Get-BcEndpointAssetQueryCount -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
