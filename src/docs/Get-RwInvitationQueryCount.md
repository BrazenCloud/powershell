...
external help file:
Module Name: Runway
online version: https://docs.microsoft.com/en-us/powershell/module/runway/get-rwinvitationquerycount
schema: 2.0.0
---

# Get-RwInvitationQueryCount
...
```
Get-RwInvitationQueryCount -IncludeSubgroups -Skip <Int32> -SortDirection <String> -Take <Int32>
...
### Count
```
Get-RwInvitationQueryCount -Query <IQuery> [-Confirm] [-WhatIf] [<CommonParameters>]
```
